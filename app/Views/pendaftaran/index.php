            ...
            <form id="formPendaftaran" class="ajax-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="noregistrasi" id="noregistrasi" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Pasien <span class="text-danger">*</span></label>
                        <select name="pasienid" id="pasienid" class="form-control" required>
                            <option value="">-- Pilih Pasien --</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Registrasi <span class="text-danger">*</span></label>
                        <input type="date" name="tglregistrasi" id="tglregistrasi" class="form-control" required>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    const table = $('#tablePendaftaran').DataTable({
        processing: false,
        serverSide: false,
        ajax: {
