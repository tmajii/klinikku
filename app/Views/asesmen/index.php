            ...
            <form id="formAsesmen" class="ajax-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="kunjunganid" id="kunjunganid" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keluhan_utama" id="keluhan_utama" class="form-control" rows="4" required placeholder="Tuliskan keluhan utama pasien..."></textarea>
                    </div>
                    <div class="form-group">
