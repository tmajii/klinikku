            ...
            <form id="formKunjungan" class="ajax-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="pendaftaranpasienid" id="pendaftaranpasienid" class="form-control" >
...
if ($.fn.DataTable.isDataTable('#tableKunjungan')) {
    $('#tableKunjungan').DataTable().destroy();
}
