            ...
            <form id="formDiagnosa" class="ajax-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="asesmenid" id="asesmenid" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_diagnosa" id="nama_diagnosa" class="form-control" required placeholder="Contoh: Kolera">
                    </div>
                    <div class="form-group">
                        <label>Jenis Diagnosa <span class="text-danger">*</span></label>
                        <select name="jenis_diagnosa" id="jenis_diagnosa" class="form-control" required>
...
$(document).ready(function() {
    ...
    const table = $('#tableDiagnosa').DataTable({
        processing: false,
        serverSide: false,
        ajax: {
                        ...
                        <select name="asesmenid" id="asesmenid" class="form-control" required>
                            ...
                            <?php foreach ($asesmen as $a): ?>
                                <option value="<?= $a['id'] ?>">
                                    ...
                                    (<?= date('d/m/Y', strtotime($a['tglkunjungan'])) ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
    ...
    const table = $('#tableDiagnosa').DataTable({
        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    return `
                        <button class="btn btn-sm btn-warning" onclick="editDiagnosa(${row.id})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-danger" onclick="deleteDiagnosa(${row.id})">
                            <i class="fas fa-trash"></i>
                        </button>
                    `;
                }
